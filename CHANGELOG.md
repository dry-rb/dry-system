...
- Allow imported components to be lazy loaded when both strings and symbols are given as the namespace to `Container.import`. (@timriley in #287)

[1.2.4]: https://github.com/dry-rb/dry-system/compare/v1.2.3...v1.2.4

## [1.2.3] - 2025-07-29

### Added

- Add :register after-hook to detect container key registration dynamically. (@alassek in #274)

### Fixed

- Re-register components from manifest registrars in apps that reload the container (e.g. when using dry-rails and Rails development mode). (@alassek in #286)

### Changed

- :finalize after-hook now executes before container freeze to allow mutation. (@alassek in #274)

[1.2.3]: https://github.com/dry-rb/dry-system/compare/v1.2.2...v1.2.3

## [1.2.2] - 2025-01-31

### Fixed

- Syntax errors on 3.3.0. (@flash-gordon in #284)

[1.2.2]: https://github.com/dry-rb/dry-system/compare/v1.2.1...v1.2.2

## [1.2.1] - 2025-01-08

### Fixed

- `eager_load` was removed from `finalize!`. It was introduced with `true` by default that wasn't the intention #281. (@flash-gordon in #282)

[1.2.1]: https://github.com/dry-rb/dry-system/compare/v1.2.0...v1.2.1

## [1.2.0] - 2025-01-07

### Added

- Option to skip eager loading during finalize with `eager_load: false`. (@cllns in #276)

### Changed

- Update required Ruby version to 3.1. (@flash-gordon)

[1.2.0]: https://github.com/dry-rb/dry-system/compare/v1.1.1...v1.2.0
...
[1.1.1]: https://github.com/dry-rb/dry-system/compare/v1.1.0...v1.1.1

## [1.1.0] - 2024-10-31

[1.1.0]: https://github.com/dry-rb/dry-system/compare/v1.1.0.beta2...v1.1.0

## [1.1.0.beta2] - 2024-09-25

### Changed

- Allow provider sources to use a custom superclass. This requires a custom provider registrar to be configured, with its own implementations of `#provider_source_class` (the superclass to use) and `#provider_source_options` (custom initialization args to pass to the provider source). (@alassek, @timriley in #275)

[1.1.0.beta2]: https://github.com/dry-rb/dry-system/compare/v1.1.0.beta1...v1.1.0.beta2

## [1.1.0.beta1] - 2024-07-03

### Added

- Add `Dry::System::ProviderRegistrar#target_container`, to be passed when initializing providers. By default this is an alias of `#container`. This allows for custom provider registrars to override `#target_container` to provide a custom `#target` within providers. An overridden value **MUST** still wrap the original `#target_container` to ensure components are registered in the right place. (@timriley in #270)

### Changed

- Make `Dry::System::ProviderRegistrar` public API. (@timriley in #270)
- When registering a provider source, you can now provide a `provider_options:` hash of default options for providers to be registered using that source. The one provider option currently supported is `namespace:`. (@timriley in #271)
- Load providers when accessing them via `Dry::System::ProviderRegistrar#[]`. The previous, behavior of `#[]` returning `nil` if a provider had not been explicitly loaded was a potential source of confusion. Now `#[]` can serve as the one and only interface for fetching a provider. (@timriley in #273)

[1.1.0.beta1]: https://github.com/dry-rb/dry-system/compare/v1.0.1...v1.1.0.beta1
...
[1.0.1]: https://github.com/dry-rb/dry-system/compare/v1.0.0...v1.0.1

## [1.0.0] - 2022-11-18

### Fixed

- Only use DidYouMean-integrated Error for Component loading failure. (@cllns, @solnic in #261)

### Changed

- This version uses dry-core 1.0 and dry-configurable 1.0. (@solnic, @flash-gordon)
- Raise error on import after finalize. (@timriley, @tak1n in #254)
- Validate settings even if loader does not set value. (@oeoeaio in #246)
- Remove all deprecated functionality and deprecation messages. (@timriley in #255)
- Use main dry/monitor entrypoint for autoloading. (@timriley in #257)
- Use dry-configurable 1.0. (@flash-gordon in 43c7909)
- Use dry-core 1.0. (@flash-gordon in 3d0cf95)
- Remove dry-container dependency and update to use `Dry::Core::Container`. (@solnic in 2b76554)

[1.0.0]: https://github.com/dry-rb/dry-system/compare/v0.27.2...v1.0.0
...
[0.27.2]: https://github.com/dry-rb/dry-system/compare/v0.27.1...v0.27.2
...
[0.27.1]: https://github.com/dry-rb/dry-system/compare/v0.27.0...v0.27.1
...
[0.27.0]: https://github.com/dry-rb/dry-system/compare/v0.26.0...v0.27.0
...
[0.26.0]: https://github.com/dry-rb/dry-system/compare/v0.25.0...v0.26.0
...
- Import root components via `nil` import namespace. (@timriley in #236)
- Allow deeper `Provider::Source` hierarchies. (@timriley, @solnic in #240)
- Prefer local components when importing. (@timriley, @solnic in #241)

[0.25.0]: https://github.com/dry-rb/dry-system/compare/v0.24.0...v0.25.0
...
[0.24.0]: https://github.com/dry-rb/dry-system/compare/v0.23.0...master
...
- Providers can no longer implicitly re-start themselves while in the process of starting and cause an infinite loop. (@timriley in #213)
...
[0.23.0]: https://github.com/dry-rb/dry-system/compare/v0.22.0...v0.23.0
...
[0.22.0]: https://github.com/dry-rb/dry-system/compare/v0.21.0...v0.22.0
...
- Allow bootsnap for Rubies up to 3.0.x. (@pusewicz in #196)

[0.21.0]: https://github.com/dry-rb/dry-system/compare/v0.20.0...v0.21.0
...
[0.20.0]: https://github.com/dry-rb/dry-system/compare/v0.19.2...v0.20.0
...
[0.19.2]: https://github.com/dry-rb/dry-system/compare/v0.18.2...v0.19.2
...
[0.18.2]: https://github.com/dry-rb/dry-system/compare/v0.19.1...v0.18.2
...
[0.19.1]: https://github.com/dry-rb/dry-system/compare/v0.19.0...v0.19.1
...
[0.19.0]: https://github.com/dry-rb/dry-system/compare/v0.18.1...v0.19.0
...
[0.18.1]: https://github.com/dry-rb/dry-system/compare/v0.18.0...v0.18.1
...
[0.18.0]: https://github.com/dry-rb/dry-system/compare/v0.17.0...v0.18.0

## [0.17.0] - 2020-02-19

### Fixed

- Works with the latest dry-configurable version. (@solnic in #141)

### Changed

- Depends on dry-configurable `=> 0.11.1` now. (@solnic)

[0.17.0]: https://github.com/dry-rb/dry-system/compare/v0.16.0...v0.17.0
...
[0.16.0]: https://github.com/dry-rb/dry-system/compare/v0.15.0...v0.16.0
...
[0.15.0]: https://github.com/dry-rb/dry-system/compare/v0.14.1...v0.15.0
...
[0.14.1]: https://github.com/dry-rb/dry-system/compare/v0.14.0...v0.14.1

## [0.14.0] - 2020-01-21

### Fixed

- Misspelled plugin name raises meaningful error. (@cgeorgii in #132)
- Fail fast if auto_registrar config contains incorrect path. (@cutalion)

[0.14.0]: https://github.com/dry-rb/dry-system/compare/v0.13.2...v0.14.0
...
[0.13.2]: https://github.com/dry-rb/dry-system/compare/v0.13.1...v0.13.2
...
[0.13.1]: https://github.com/dry-rb/dry-system/compare/v0.13.0...v0.13.1
...
[0.13.0]: https://github.com/dry-rb/dry-system/compare/v0.12.0...v0.13.0
...
[0.12.0]: https://github.com/dry-rb/dry-system/compare/v0.11.0...v0.12.0
...
[0.11.0]: https://github.com/dry-rb/dry-system/compare/v0.10.1...v0.11.0
...
[0.10.1]: https://github.com/dry-rb/dry-system/compare/v0.10.0...v0.10.1
...
[0.10.0]: https://github.com/dry-rb/dry-system/compare/v0.9.2...v0.10.0
...
[0.9.2]: https://github.com/dry-rb/dry-system/compare/v0.9.1...v0.9.2
...
[0.9.1]: https://github.com/dry-rb/dry-system/compare/v0.9.0...v0.9.1
...
[0.9.0]: https://github.com/dry-rb/dry-system/compare/v0.8.1...v0.9.0
...
[0.8.1]: https://github.com/dry-rb/dry-system/compare/v0.8.0...v0.8.1
...
[0.8.0]: https://github.com/dry-rb/dry-system/compare/v0.7.3...v0.8.0
...
[0.7.3]: https://github.com/dry-rb/dry-system/compare/v0.7.2...v0.7.3
...
[0.7.2]: https://github.com/dry-rb/dry-system/compare/v0.7.1...v0.7.2
...
[0.7.1]: https://github.com/dry-rb/dry-system/compare/v0.7.0...v0.7.1
...
[0.7.0]: https://github.com/dry-rb/dry-system/compare/v0.6.0...v0.7.0
...
[0.6.0]: https://github.com/dry-rb/dry-system/compare/v0.5.1...v0.6.0
...
[0.5.1]: https://github.com/dry-rb/dry-system/compare/v0.5.0...v0.5.1
...
[0.5.0]: https://github.com/dry-rb/dry-system/compare/v0.4.3...v0.5.0
...
[0.4.3]: https://github.com/dry-rb/dry-system/compare/v0.4.2...v0.4.3
...
[0.4.2]: https://github.com/dry-rb/dry-system/compare/v0.4.1...v0.4.2
...
[0.4.1]: https://github.com/dry-rb/dry-system/compare/v0.4.0...v0.4.1
...
[0.4.0]: https://github.com/dry-rb/dry-system/compare/v0.3.0...v0.4.0
...
[0.3.0]: https://github.com/dry-rb/dry-system/compare/v0.2.0...v0.3.0
...
[0.2.0]: https://github.com/dry-rb/dry-system/compare/v0.1.0...v0.2.0
...
[0.1.0]: https://github.com/dry-rb/dry-system/compare/v0.0.2...v0.1.0
...
[0.0.2]: https://github.com/dry-rb/dry-system/compare/v0.0.1...v0.0.2
